...
treasure available to anyone clever enough to solve the puzzle associated with
it. Ward reported that around 1817, a man named Thomas Jefferson Beale stumbled 
upon gold and silver deposits in what is now Colorado. Agreeing to keep it all a 
secret, Beale's team had spent the better part of two years quietly mining, then 
had taken the metals to Virginia by wagon and buried them in a vault underground 
between 1819 and 1821. Beale had written three notes explaining where the treasure 
was and who had legal rights to shares in it, encrypting each of these using a 
different text.

Eventually, the second of the three texts was deciphered using a slightly altered
version of the Declaration of Independence. Each number in the text corresponded to
a word in the U.S. Declaration of Independence. The first letter of each of those 
words spelled the plaintext with a few modifications for errors and spelling.

Your mission today is to go treasure hunting and to write a program to decipher 
Beale's message.
...
DECLARATION OF INDEPENDENCE
    ...
    states to prove this let facts be submitted to a candid world he has refused 
    ...
    suspended he has utterly neglected to attend to them he has refused to pass 
    ...
    their substance he has kept among us in times of peace standing armies without
    the consent of our legislatures he has affected to render the military 
    independent of and superior to the civil power he has combined with others 
    ...
    inhabitants of these states for cutting off our trade with all parts of the
    ...
    tried for pretended offenses for abolishing the free system of English laws 
    ...
    cases whatsoever he has abdicated government here by declaring us out of 
    ...
    themselves by their hands he has excited domestic insurrections amongst us 
    ...
    been answered only by repeated injury a prince whole character is thus marked
    ...
    in war in peace friends we therefore the representatives of the united states 
...
INPUT DESCRIPTION
You'll be given a list of numbers, comma separated, representing the ciphertext
given by Beale. Example:
...
85, 35, 371, 59, 196, 81, 92, 191, 106, 273, 60, 394, 620, 270, 220, 106, 388, 287,
...
29, 125, 14, 20, 37, 105, 28, 248, 16, 159, 7, 35, 19, 301, 125, 110, 486, 287, 
98, 117, 511, 62, 51, 220, 37, 113, 140, 807, 138, 540, 8, 44, 287, 388, 117, 18,
79, 344, 34, 20, 59, 511, 548, 107, 603, 220, 7, 66, 154, 41, 20, 50, 6, 575, 
...
31, 10, 38, 140, 297, 61, 603, 320, 302, 666, 287, 2, 44, 33, 32, 511, 548, 10, 
6, 250, 557, 246, 53, 37, 52, 83, 47, 320, 38, 33, 807, 7, 44, 30, 31, 250, 10, 
15, 35, 106, 160, 113, 31, 102, 406, 230, 540, 320, 29, 66, 33, 101, 807, 138, 
301, 316, 353, 320, 220, 37, 52, 28, 540, 320, 33, 8, 48, 107, 50, 811, 7, 2, 
113, 73, 16, 125, 11, 110, 67, 102, 807, 33, 59, 81, 158, 38, 43, 581, 138, 19, 
85, 400, 38, 43, 77, 14, 27, 8, 47, 138, 63, 140, 44, 35, 22, 177, 106, 250, 
314, 217, 2, 10, 7, 1005, 4, 20, 25, 44, 48, 7, 26, 46, 110, 230, 807, 191, 34,
112, 147, 44, 110, 121, 125, 96, 41, 51, 50, 140, 56, 47, 152, 540, 63, 807, 28,
42, 250, 138, 582, 98, 643, 32, 107, 140, 112, 26, 85, 138, 540, 53, 20, 125, 
371, 38, 36, 10, 52, 118, 136, 102, 420, 150, 112, 71, 14, 20, 7, 24, 18, 12, 
807, 37, 67, 110, 62, 33, 21, 95, 220, 511, 102, 811, 30, 83, 84, 305, 620, 15, 
2, 10, 8, 220, 106, 353, 105, 106, 60, 275, 72, 8, 50, 205, 185, 112, 125, 540, 
65, 106, 807, 138, 96, 110, 16, 73, 33, 807, 150, 409, 400, 50, 154, 285, 96, 
106, 316, 270, 205, 101, 811, 400, 8, 44, 37, 52, 40, 241, 34, 205, 38, 16, 46,
47, 85, 24, 44, 15, 64, 73, 138, 807, 85, 78, 110, 33, 420, 505, 53, 37, 38, 
22, 31, 10, 110, 106, 101, 140, 15, 38, 3, 5, 44, 7, 98, 287, 135, 150, 96, 33,
84, 125, 807, 191, 96, 511, 118, 40, 370, 643, 466, 106, 41, 107, 603, 220, 275,
30, 150, 105, 49, 53, 287, 250, 208, 134, 7, 53, 12, 47, 85, 63, 138, 110, 21, 
112, 140, 485, 486, 505, 14, 73, 84, 575, 1005, 150, 200, 16, 42, 5, 4, 25, 42, 
...
OUTPUT DESCRIPTION
Your program should consume the input and decrypt it. Remember - the first letter
of that word number from the US Declaration of Independence. Spacing, punctuation,
capitalization, and fixing spelling is left as an exercise to the treasure seeker
(as Beale intended). The above letter was intended to decrypt to:

I have deposited in the county of Bedford, about four miles from Buford's, in an
...
The above is securely packed in iron pots, with iron covers. The vault is roughly
lined with stone, and the vessels rest on solid stone, and are covered with others.
Paper number "1" describes the exact locality of the vault so that no difficulty 
will be had in finding it.



NOTES
Beale counts the first word as index "1", not "0" - a difference from most computer
programming languages. Account for that.

There are 1322 words in the above Declaration of Independence. If you see a number
larger than that, wrap around.

The inspiration for this challenge comes from the Damn Interesting website and my
love of the Nicholas Cage movie series "National Treasure". For more info see the
...
#Getting the char corresponding to every number and combining them.
#It's important to remember that Beale counts the first word as 1, not 0
plaintext = "".join([declindchars[num - 1] for num in inputctnums])

#Saving the output
ptfile = open("Easy - 274 output.txt", 'w')
ptfile.write(plaintext)
ptfile.close()

#IMPORTANT: We have to take into account that the deciphered pt won't have any space
#or punctuation mark, so the text won't be completely readable.
#Besides, due to unknown factors, some of the letters don't seem to correspond to
#what they should, so the output may seem meaningless. This is completely normal
#and happened also in the original plaintext.